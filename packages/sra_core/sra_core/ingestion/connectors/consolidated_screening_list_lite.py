...
class ConsolidatedScreeningListLiteConnector(PublicEvidenceConnector):
    def __init__(self, *, config: ConnectorConfig | None = None) -> None:
        super().__init__("consolidated_screening_list_lite", config=config)
            ...
            promoted.append(
                {
                    ...
                    "screening_event_id": f"screening_event:{record.source_record_id}",
                    ...
                    "warnings": ["screening_summary_only_compliance_context"],
                }
            )
        return promoted
