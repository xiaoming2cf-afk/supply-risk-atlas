...
from services.api.services.graph_service import (
    ...
    route_graph_layers,
    route_graph_matrix,
    route_graph_node_catalog,
    route_graph_path_view,
    route_graph_snapshots,
    route_graph_scenario_overlay,
    route_graph_source_coverage,
    route_graph_supply_relationships,
    route_graph_demand_relationships,
    route_graph_production_dependencies,
    route_graph_supply_demand_balance,
...
def create_app() -> Any:
    ...
    graph_routes.register(
        ...
        route_graph_node_catalog=route_graph_node_catalog,
        route_graph_source_coverage=route_graph_source_coverage,
        route_graph_supply_relationships=route_graph_supply_relationships,
        route_graph_demand_relationships=route_graph_demand_relationships,
        route_graph_production_dependencies=route_graph_production_dependencies,
        route_graph_supply_demand_balance=route_graph_supply_demand_balance,
