...
def platform_status_payload(
    ...
    return {
        ...
        "deploymentVersionReadiness": {
            "status": str(version.get("deployment_readiness_state") or "not_verified"),
            ...
            "deploymentState": str(version.get("deployment_readiness_state") or "not_verified"),
            "staleOrUnverified": bool(version.get("deployment_stale_or_unverified")),
            "unavailable": bool(version.get("deployment_unavailable")),
            "lastCheckedAt": str(version.get("last_checked_at") or "not_verified"),
