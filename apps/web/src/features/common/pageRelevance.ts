...
export type PageRelevancePolicy = {
  ...
  displayTiers: Array<"primary" | "supporting" | "audit_details" | "developer_diagnostics">;
...
export const pageRelevancePolicies: Record<DashboardPageId, PageRelevancePolicy> = {
  "system-health-center": {
    ...
    purpose: "Data trust page for public evidence coverage, source registry trust, graph/evidence lineage, and research caveats. Production readiness is not claimed.",
    allowedMajorSections: [
      "public_evidence_coverage",
      "source_registry_trust",
      "evidence_lineage",
      "research_fixture_caveats",
      "not_production_ready",
      "data_mode",
      "graph_mode",
    ...
    requiredSignals: [...sharedSignals, "public_evidence_coverage", "source_registry_trust", "evidence_lineage", "source_coverage"],
    displayTiers: ["primary", "supporting", "audit_details"],
    disallowedMajorSections: ["scenario_inputs", "optimizer_actions", "report_export", "dense_graph_canvas", "runtime_logs_primary", "service_health_primary", "deployment_status_primary"],
