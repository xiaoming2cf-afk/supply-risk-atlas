...
const LABEL_OVERRIDES = new Map<string, string>([
  ...
  ["before_cvar95", "Before tail loss"],
  ...
  ["cvar_95", "Average tail loss"],
  ["cvar95_loss", "Severe tail loss"],
  ...
  ["evidence_ref_count", "Evidence records"],
  ["evidence_refs", "Evidence records"],
  ...
  ["fixture_graph", "Research fixture mode"],
  ["fixture_connector", "Fixture connector"],
  ["fixture_ready", "Fixture ready"],
  ["fixtureGraph", "Research fixture mode"],
  ...
  ["fixture_proxy_not_calibrated", "Research fixture calibration"],
  ...
  ["latest_cvar_95", "Latest tail loss"],
  ...
  ["previous_cvar_95", "Previous tail loss"],
...
const NODE_LABEL_OVERRIDES = new Map<string, string>([
  ...
  ["product:HBM", "HBM"],
  ["product_grade:hbm", "HBM"],
  ["product_grade:advanced_logic", "Advanced logic"],
  ["product:DRAM", "DRAM"],
  ["product:NAND", "NAND"],
  ["process:CMP", "CMP"],
