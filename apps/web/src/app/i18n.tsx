...
const phraseCopy: Record<string, TranslationPair> = {
  ...
  "Total relationships": { zh: "总关系", fr: "Relations totales" },
  "Relationship type": { zh: "关系类型", fr: "Type de relation" },
  ...
  "Candidate entity types": { zh: "候选实体类型", fr: "Types d'entites candidates" },
  Promote: { zh: "发布", fr: "Promouvoir" },
  Entities: { zh: "实体", fr: "Entites" },
  Relationships: { zh: "关系", fr: "Relations" },
  "Data assets": { zh: "数据资产", fr: "Actifs de donnees" },
  "Data asset type": { zh: "数据资产类型", fr: "Type d'actif de donnees" },
